        ...
        {!p.ok ? (
          ...
          <>
            ...
            <p className="sp-pay-lede">
              {usdc(p.value.declaredUsdc)} was paid for it. Claim it into your own wallet: the fee is covered, a book opens for you on the way if
              you have none, and a receipt is written that anyone can open. Nothing about this asks you to decide to invest; it already
              happened.
            </p>
            <ClaimButton
              payer={payer}
